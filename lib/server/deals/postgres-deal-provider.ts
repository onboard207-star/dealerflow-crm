...
type DealRow = { id: string; organization_id: string; location_id: string; customer_id: string; lead_id: string; appointment_id: string | null; showroom_visit_id: string | null; primary_vehicle_id: string; inventory_unit_id: string | null; owner_user_id: string | null; deal_number: string; status: DealRecord["status"]; purchase_type: DealRecord["purchaseType"] | null; agreed_price_cents: number | null; idempotency_key: string };
...
const columns = "id, organization_id, location_id, customer_id, lead_id, appointment_id, showroom_visit_id, primary_vehicle_id, inventory_unit_id, owner_user_id, deal_number, status, purchase_type, agreed_price_cents, idempotency_key";
