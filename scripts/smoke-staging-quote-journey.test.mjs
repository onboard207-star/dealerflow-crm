...
import { normalizeReactMarkup, parseArguments } from "./smoke-staging-quote-journey.mjs";
...
describe("staging Quote journey acceptance", () => {
  ...
  it("normalizes React hydration comments for exact-version proposal checks", () => {
    expect(normalizeReactMarkup("<p>Version <!-- -->2 · presented</p>")).toContain("Version 2");
  });
