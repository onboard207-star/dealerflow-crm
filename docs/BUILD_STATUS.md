...
- Added a canonical, typed delivery-readiness evaluation covering contracted state, exact accepted Quote resolution, physical inventory validity, and required-document completion. Required documents in `pending` or `waived` state remain blockers; DealerFlow does not infer compliance completion.
