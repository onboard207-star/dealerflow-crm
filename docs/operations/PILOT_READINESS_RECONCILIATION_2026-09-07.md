...
| --- | --- | --- | --- | --- |
| PILOT-P1-01 | P1 | Communications | No tenant-specific, test-destination acceptance for required account email and approved customer email/SMS paths, including consent/STOP, duplicate inbound/status events, retries, provider outage, and degraded behavior. | Approve the pilot channels, configure sandbox/restricted staging routes, and pass outbound, inbound, status, failure, retry, consent, duplicate, and outage acceptance without contacting real customers. |
